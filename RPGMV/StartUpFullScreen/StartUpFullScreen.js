...
(function () {
    ...
    Scene_Boot.prototype.start = function() {
        ...
        //if (noConfigFile) Graphics.requestFullScreen(); // If no config file default to fullscreen
    ...
    ConfigManager.applyData = function(config) {
        ...
        this.startUpFullScreen = this.readConfigFullScreen(config, 'startUpFullScreen');
    };

    // This replaces readFlag function as it will not read a value if there is no configuration file
	ConfigManager.readConfigFullScreen = function(config, name) {
