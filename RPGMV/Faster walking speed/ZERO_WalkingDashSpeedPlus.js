...
== Changelog ==
1.4 - Simplified code by using only this.isMoveRouteForcing()
1.3 - Change Game_Player.prototype.isNormal from overwrite to alias
1.2 - Add option to change dash speed
1.1 - Fix movement speed always set to 5
...
(function($) {
    ...
    */
    ...
    Game_Player.prototype.realMoveSpeed = function() {
        // if (duringEvent) return this._moveSpeed + (this.isDashing() ? 1 : 0); // Use default speed during events - deprecated
        if (this.isMoveRouteForcing()) return this._moveSpeed + (this.isDashing() ? 1 : 0); // Use default speed during events
