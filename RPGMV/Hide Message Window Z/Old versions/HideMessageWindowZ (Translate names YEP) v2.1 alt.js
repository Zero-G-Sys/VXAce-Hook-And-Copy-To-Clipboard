...
(function ($) {
  $.replacements = { // Need to add translated to regex ignore in Clipboard_illule
    //'春': 'Haru', // Names
    'ヨコシマ': 'Yokoshima',
    '一ノ瀬 葉月': 'Hazuki Ichinose',
    'じいさん': 'Jiisan',
    '女性': 'Lady',
    '男の子': 'Boy',
    '女の子': 'Girl',
    'セクハラエロ部長': 'Sexual Harassment Manager',
    '部長': 'Director',
    '女性社員': 'Female Employee',
    '店員': 'Clerk',
    'イヤミな後輩': 'Unpleasant Kouhai',
    '男性社員': 'Male Employee',
    'ムカつく先輩': 'Annoying Senpai',
    '警官': 'Cop',
  }
  ...
  if(typeof Window_NameBox == 'function'){
    ...
    Window_NameBox.prototype.refresh = function(text, position) {
      ...
      for (const [key, value] of Object.entries($.replacements)) {
        this._text = this._text.replace(key, value);
      }
