...
(function($){
		...
		// Params not working set maxWidth here
		var maxWidth = 40;
		var maxWidthWithoutFace = 50;
    ...
    const capitalize = (str, lower = false) =>
		...
		// Wordwrap dialoge
    Window_Message.prototype.convertWhiteSpace = function(text) {
    	...
    	if ($gameMessage._faceName == ""){
			...
			var splittedText = [ text.substring(0, text.indexOf('\n')), text.substring(text.indexOf('\n') + 1) ];
